...
import CategoryDetailedPage from '@/pages/categoryDetailedPage';
    ...
    <>
      <Routes>
        <Route path='/' element={<Layout />}>
          ...
          ></Route>
          <Route path='category_list' element={<CategoryListPage />}></Route>
          <Route
            path='category_list/:slug'
            element={<CategoryDetailedPage />}
          ></Route>
          <Route path='tag_list' element={<TagListPage />}></Route>
